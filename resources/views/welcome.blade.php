...
<body>
    ...
    <div class="containers">
        <div class="tables">
            <table class="navi">
                <tr class="">
                  <th class="cont"><img src="{{public_path('favicon.ico')}}" alt="" width="100" class="im"></th>
                  <th class="cont">
        ...
        <div>
            <div class="cont">
                ...
                <h3 class="text-center mb-1">
                    {{$individuo->nombres}} {{$individuo->paterno}} {{$individuo->materno}}
                </h3>
                {{asset('storage/'. $curso->certificado)}}
                {{-- <img class="mb-4 w-full" src="{{asset('storage/'. $curso->certificado)}}" alt=""> --}}
                <p>En reconocimiento por su participación en el curso de {{-- {{$curso->nombre}} --}}, módulo organizado por el Capítulo de Ingenieria de y de systemas."</p>
                <p>llevado a cabo desde el {{-- {{$curso->fecha_inicio}} --}} hasta de {{-- {{$curso->fecha_fin}} --}} del {{-- {{$curso->fecha_fin}} --}}, con una duración de {{-- {{$curso->duracion}} --}} días.<span class="font-weight-bold text-uppercas"></span>
            ...
            <div>
                <table>
                    <tr>
                        ...
                        <th>
                            <div>
                                <img src="https://chart.googleapis.com/chart?chs=220x220&amp;cht=qr&amp;chl=https://developers.google.com/chart/infographics/docs/qr_codes&amp;choe=UTF-8" />
                            </div>
                            <div>
                                {{$matricula->codigo}}
                                {{$individuo->nombres}}
